...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Deprecated mining-only input; ignored by evolution mode.",
    )
    ...
    parser.add_argument("--debug-symbol-count", type=int, default=20,
                        help="Deprecated mining-only option; ignored by evolution mode.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.text_data_path or args.write_data_artifacts:
        print(
            ...
            "this mode optimizes expressions/subsets/params on structured panel data.",
            file=sys.stderr,
        )
